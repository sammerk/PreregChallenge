...
### M1: MCFA with level-variant measurement models
```{r MCFA_tp_unres2, echo=T, warning=F, message=F, cache = T, eval = T, results = 'hide'}
...
* The fitindices of M1 were `r fpf_mp("MCFA_tp_unres.out")`  
* An estimation of ICC(1)-coeffients resulted in a range of `r round(min(c(psychometric::ICC1.lme(tp_01_np, IDnum, rawdata_long_np), psychometric::ICC1.lme(tp_02_np, IDnum, rawdata_long_np), psychometric::ICC1.lme(tp_03_np, IDnum, rawdata_long_np), psychometric::ICC1.lme(tp_04_np, IDnum, rawdata_long_np))),2)` and `r round(max(c(psychometric::ICC1.lme(tp_01_np, IDnum, rawdata_long_np), psychometric::ICC1.lme(tp_02_np, IDnum, rawdata_long_np), psychometric::ICC1.lme(tp_03_np, IDnum, rawdata_long_np), psychometric::ICC1.lme(tp_04_np, IDnum, rawdata_long_np))),2)`.

### M2:  MCFA with level-invariant measurement models

```{r MCFA_res, echo=T, warning=F, message=F, cache = T, eval = T, results = 'hide'}
# Mplusmodell
MCFA_tp_res <- mplusObject(
...
MCFA_tp_res_fit <- mplusModeler(MCFA_tp_res, "MCFA_tp_res.dat", run = 1)
```

* The fitindices of M2 were `r fpf_mp("MCFA_tp_res.out")`)
* A modelcomparison test resulted in:
```{r MCFA_compare_tp_unres_tp_res, eval=T, echo=T, warning=F, message=F, cache = T}
compareModels(readModels("MCFA_tp_unres.out"), readModels("MCFA_tp_res.out"), diffTest = T, show = "summaries")
```
* The ICC of the latent variable was `r round(0.129/(0.229 + 0.129),2)`
